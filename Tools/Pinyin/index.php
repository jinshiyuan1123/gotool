...
<div class="container clearfix" >
  ...
  <div class="col-sm-6">
    <div class="panel panel-default">
      <div class="panel-heading"><button type="button" class="btn btn-default" onclick="layer.msg('如有问题请联系QQ1170535111');">拼音输出</button><button type="button" class="btn btn-info" id="copy" data-clipboard-target='#textareaCode_py'>复制内容</button><button type="button" class="btn btn-success" id="read">朗读</button></div>
...
<script type="text/javascript" src="py.js"></script>
