					...
					<div class="panel-body">
						...
						<form action="?step=2" class="form-horizontal" method="post" role="form">
							<div class="cd-nugget-info">
								...
								<h1>2.程序为开源项目</h1>
								<h1>3.雪狼教http://v2.soubei1123.cn/发布</h1>
								<h3 id="msg"></h3>
...
?>";
				if(file_put_contents('../config.php',$data)){
					...
					(1, '恰啦高防ddos无视CC攻击CDN/云空间', '恰啦高防ddos无视CC攻击CDN/云空间', 'https://www.qia.la', 0, 0, 0),
					(2, 'YoungxjTools', 'YoungxjTools', 'https://v2.soubei1123.cn/', 1, 0, 2);
					...
					(1, '{$web_url}', '娱乐网工具箱', '二维码生成,dns解析查询,短网址生成,icp备案查询,ip定位,全民k歌解析,在线ping,端口扫描,子域名扫描,QQ在线状态,在线运行,时间戳转换,ua查询,whois查询,字符加解密', '娱乐网提供二维码生成,dns解析查询,短网址生成,icp备案查询,ip定位,全民k歌解析,在线ping,端口扫描,子域名扫描,QQ在线状态,在线运行,时间戳转换,ua查询,whois查询,字符加解密等优质的小工具,更加方便的使用我们的小工具,便捷站长使用工具', 'Youngxj', '', '', '', '', '127.0.0.255', 'Youngxj', 1, 1, 'YoungxjTools', '123456', 'admin@xd0.com', 2, '1', 2, '<h2>浏览器打开</h2>', 0);
