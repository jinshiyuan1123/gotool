...
if(getParam('domain') == 'reply'){
  ...
  if($talk_replys){
    ...
    .qmbox .header{width:100%;padding-top:50px;background:url("#/content/plugins/kl_sendmail/bian.jpg") repeat-x;}
